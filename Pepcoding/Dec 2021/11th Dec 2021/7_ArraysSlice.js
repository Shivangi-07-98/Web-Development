...
scopy[0].age = 110; // change occurs in original array too
// Do not use slice for object array to make copy of array, use for integer boolean 
displayObjectArray(anarr);
displayObjectArray(scopy);
